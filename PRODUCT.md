...
- Verification baseline (2026-08-12): Playwright 306 passed + 29 skipped, cargo 594 green; every new Tauri command must get a handler in mock-tauri.ts. The counts are a scale, not a contract — they move with every feature, and the rule after the semicolon is the part that does not.
